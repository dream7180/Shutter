...
void ErrorDlg::OnReport()
{
	...
	try
	{
		...
		String msg= L"Shutter error report. Please describe what you have been doing in Shutter when this error occurred:\n\n\n";

		mail.SendFiles(files, names, &msg, "Error Report", "dream7180@gmail.com");
	}
	CATCH_ALL_W(this)
