...
BOOL OptionsFileTypes::InitDialog()
{
	...
	types_wnd_.InsertColumn(0, _T("File Type"), LVCFMT_LEFT, Pixels(180));
	types_wnd_.InsertColumn(1, _T("Extension"), LVCFMT_LEFT, Pixels(90));
	types_wnd_.InsertColumn(2, _T("Type Indicator"), LVCFMT_LEFT, Pixels(85));
	types_wnd_.InsertColumn(3, _T("No EXIF"), LVCFMT_LEFT, Pixels(80));
