...
static const ColDef g_column_definitions[]=
{
	...
	*/
	{ _T("Photo File Name"),			_T("Photo"),				_T(""),		LVCFMT_LEFT,	215 },
	{ _T("File Extension"),				_T("File Ext"),				_T(""),		LVCFMT_LEFT,	 60 },
	{ _T("Date and Time"),				_T("Date and Time"),		_T(""),		LVCFMT_LEFT,	155 },
	{ _T("Camera Make"),				_T("Make"),					_T(""),		LVCFMT_LEFT,	 85 },
	{ _T("Camera Model"),				_T("Model"),				_T(""),		LVCFMT_LEFT,	135 },
	{ _T("Lens Model"),					_T("Lens Model"),			_T(""),		LVCFMT_LEFT,	135 },
	{ _T("ISO Speed"),					_T("ISO Speed"),			_T(""),		LVCFMT_RIGHT,	 70 },
	{ _T("Exposure Time"),				_T("Exp. Time"),			_T("s"),	LVCFMT_RIGHT,	 75 },
	{ _T("F/Stop"),						_T("F/Stop"),				_T(""),		LVCFMT_RIGHT,	 60 },
	{ _T("Focal Length"),				_T("Focal Length"),			_T("mm"),	LVCFMT_RIGHT,	 70 },
	{ _T("Photo Dimensions"),			_T("Dimensions"),			_T(""),		LVCFMT_RIGHT,	105 },
	{ _T("File Size"),					_T("File Size"),			_T(""),		LVCFMT_RIGHT,	 85 },
