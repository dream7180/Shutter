...
//#define	WEB_SITE	L"https://github.com/dream7180/Shutter"
...
//		about_ += _T("Free software released under the terms of the GNU Public License.");
		...
		GetDlgItem(IDC_LINK)->SetWindowText(L"Project Home: <a href=\"" WEB_SITE L"\">https://github.com/dream7180/Shutter</a>\n\nShutter is developed based on the inactive project <a href=\"" CODE_SITE L"\">ExifPro</a>");//, <a href=\"" OFF_SITE L"\">www.exifpro.com</a>");
